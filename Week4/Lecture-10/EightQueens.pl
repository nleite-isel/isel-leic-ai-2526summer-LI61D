...
% solution predicate
solution([], Init, Init) :- write('Empty board, '), write(Init), nl.

solution([X/Y | Others], Init, CounterAux) :-     % First queen at X/Y, other queens at Others
	solution(Others, Init, Counter),                    % Find solution for all other queens
